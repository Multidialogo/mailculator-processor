...
func New(cfg Config) (*App, error) {
	...
	sentCallbackPipe := pipeline.NewSentCallbackPipeline(cfg.getCallbackPipelineConfig(), outboxService)
	failedCallbackPipe := pipeline.NewFailedCallbackPipeline(cfg.getCallbackPipelineConfig(), outboxService)

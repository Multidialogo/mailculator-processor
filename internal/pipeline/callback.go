...
func NewSentCallbackPipeline(cfg Config, ob callbackOutboxService) *SentCallbackPipeline {
...
func NewFailedCallbackPipeline(cfg Config, ob callbackOutboxService) *FailedCallbackPipeline {
